...
public class AdminPage {
	...
	@FindBy(id = "username") WebElement adminUsernameElem;
	@FindBy(id = "password") WebElement adminPasswordElem;
	@FindBy(id = "user_type") WebElement userTypeDrop;
	@FindBy(xpath = "//button[@name='Create']") WebElement saveBtn;
	@FindBy(xpath = "//a[@class='btn btn-rounded btn-primary']") WebElement searchUserBtnElem;
	@FindBy(id = "un")WebElement searchUserElem;
	@FindBy(id = "ut")WebElement searchUserTypeDrop;
	@FindBy(name = "Search") WebElement searchUserBtn;
	@FindBy(xpath = "//a[@class='btn btn-rounded btn-warning']") WebElement resetUserElem;
